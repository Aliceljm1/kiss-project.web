...
namespace Kiss.Web.Auth.Messaging.Bindings {
	...
	internal class StandardExpirationBindingElement : IChannelBindingElement {
		...
		protected internal static TimeSpan MaximumMessageAge {
            get { return Configuration.AuthSection.Configuration.Messaging.MaximumMessageLifetime; }
		}
		...
		public MessageProtections? ProcessIncomingMessage(IProtocolMessage message) {
			...
			if (expiringMessage != null) {
				...
				ErrorUtilities.VerifyProtocol(
                    creationDate <= DateTime.UtcNow + AuthSection.Configuration.Messaging.MaximumClockSkew,
