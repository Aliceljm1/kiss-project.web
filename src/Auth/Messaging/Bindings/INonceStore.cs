...
namespace Kiss.Web.Auth.Messaging.Bindings {
	...
	public interface INonceStore {
		...
		/// <see cref="Kiss.Web.Auth.Configuration.MessagingElement.MaximumMessageLifetime"/>
		/// property, accessible via the <see cref="Kiss.Web.Auth.Configuration.Kiss.Web.AuthSection.Configuration"/>
		/// property.
		/// </remarks>
