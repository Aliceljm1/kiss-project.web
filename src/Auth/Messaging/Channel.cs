...
";
		...
		/// </summary>
		private int maximumIndirectMessageUrlLength = Configuration.AuthSection.Configuration.Messaging.MaximumIndirectMessageUrlLength;
		...
		protected virtual IDirectedProtocolMessage ReadFromRequestCore(HttpRequestInfo request)
		{
			...
			if (fields.Count == 0 && request.HttpMethod != "POST")
