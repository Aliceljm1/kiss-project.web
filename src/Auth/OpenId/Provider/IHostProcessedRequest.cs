...
namespace Kiss.Web.Auth.OpenId.Provider {
	...
	internal abstract class IHostProcessedRequestContract : IHostProcessedRequest {
		...
		void IRequest.AddResponseExtension(Kiss.Web.Auth.OpenId.Messages.IOpenIdMessageExtension extension) {
		...
		/// An instance of the extension initialized with values passed in with the request.
		/// </returns>
		Kiss.Web.Auth.OpenId.Messages.IOpenIdMessageExtension IRequest.GetExtension(System.Type extensionType) {
			throw new System.NotImplementedException();
		}
