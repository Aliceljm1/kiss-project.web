...
namespace Kiss.Web.Auth.OpenId.Provider {
	...
	using RP = Kiss.Web.Auth.OpenId.RelyingParty;
	...
	public sealed class OpenIdProvider : IDisposable {
		...
		/// </summary>
		private const string ApplicationStoreKey = "Kiss.Web.Auth.OpenId.Provider.OpenIdProvider.ApplicationStore";
		...
		public OpenIdProvider()
            : this(AuthSection.Configuration.OpenId.Provider.ApplicationStore.CreateInstance(HttpApplicationStore))
        {
		...
		private OpenIdProvider(IAssociationStore<AssociationRelyingPartyType> associationStore, INonceStore nonceStore) {
            ...
            this.SecuritySettings = AuthSection.Configuration.OpenId.Provider.SecuritySettings.CreateSecuritySettings();
			this.behaviors.CollectionChanged += this.OnBehaviorsChanged;
            foreach (var behavior in AuthSection.Configuration.OpenId.Provider.Behaviors.CreateInstances(false))
            {
