...
namespace Kiss.Web.Auth.OpenId.Extensions {
	using System.Collections.Generic;
	using Kiss.Web.Auth.Messaging;
	using Kiss.Web.Auth.OpenId.ChannelElements;
	using Kiss.Web.Auth.OpenId.Extensions.AttributeExchange;
	using Kiss.Web.Auth.OpenId.Extensions.OAuth;
	using Kiss.Web.Auth.OpenId.Extensions.ProviderAuthenticationPolicy;
	using Kiss.Web.Auth.OpenId.Extensions.SimpleRegistration;
	using Kiss.Web.Auth.OpenId.Extensions.UI;
