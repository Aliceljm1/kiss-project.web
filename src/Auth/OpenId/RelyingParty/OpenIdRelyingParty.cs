...
namespace Kiss.Web.Auth.OpenId.RelyingParty
{
    ...
    public class OpenIdRelyingParty : IDisposable
    {
        ...
        /// </summary>
        private const string ApplicationStoreKey = "Kiss.Web.Auth.OpenId.RelyingParty.OpenIdRelyingParty.HttpApplicationStore";
        ...
        public OpenIdRelyingParty()
            : this(AuthSection.Configuration.OpenId.RelyingParty.ApplicationStore.CreateInstance(HttpApplicationStore))
        {
        }
        ...
        private OpenIdRelyingParty(IAssociationStore<Uri> associationStore, INonceStore nonceStore)
        {
            ...
            this.securitySettings = AuthSection.Configuration.OpenId.RelyingParty.SecuritySettings.CreateSecuritySettings();

            foreach (var discoveryService in AuthSection.Configuration.OpenId.RelyingParty.DiscoveryServices.CreateInstances(true))
            {
                this.discoveryServices.Add(discoveryService);
            }

            this.behaviors.CollectionChanged += this.OnBehaviorsChanged;
            foreach (var behavior in AuthSection.Configuration.OpenId.RelyingParty.Behaviors.CreateInstances(false))
            {
