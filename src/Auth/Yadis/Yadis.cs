...
using Kiss.Web.Auth.OpenId;
using Kiss.Web.Auth.Xrds;

namespace Kiss.Web.Auth.Yadis
{
	/// <summary>
	...
	internal class Yadis
	{
...
#else
		internal static readonly RequestCachePolicy IdentifierDiscoveryCachePolicy = new HttpRequestCachePolicy(Kiss.Web.AuthSection.Configuration.OpenId.CacheDiscovery ? HttpRequestCacheLevel.CacheIfAvailable : HttpRequestCacheLevel.BypassCache);
#endif
		...
		internal static IncomingWebResponse Request(IDirectWebRequestHandler requestHandler, Uri uri, bool requireSsl, params string[] acceptTypes)
		{
			...
			{
				var webException = ex.InnerException as System.Net.WebException;
