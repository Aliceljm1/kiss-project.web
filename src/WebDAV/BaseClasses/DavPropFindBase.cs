...
namespace Kiss.Web.WebDAV.BaseClasses
{
    ...
    /// </remarks>	
    public abstract class DavPropFindBase : DavResourceFindBase, ICacheableDavResponse
    {
        /// <summary>
        /// Dav Resource PROPFIND Framework Base Class
        /// </summary>
        ...
        private int DavPropFindBase_ValidateDavRequest(object sender, EventArgs e)
        {
            ...
            logger.Debug("DavPropFindBase: PropertyRequestType - " + this.RequestPropertyType);
            return _returnCode;
        }
        ...
        /// Cache TTL 
        /// </summary>
        public virtual int CacheTTL
        {
            get
            {
                //By default caching is disabled
                return WebDAVConfig.Instance.DefaultCacheTTL;
            }
        }
        ...
        public virtual string CacheKey
        {
            get
            {
                return "depth:" + this.RequestDepth + "~path:" + this.RelativeRequestPath;
            }
        }
    }
}