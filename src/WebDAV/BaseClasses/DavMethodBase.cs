...
namespace Kiss.Web.WebDAV.BaseClasses
{
    ...
    public abstract class DavMethodBase : IDavRequest
    {
        ...
        int IDavRequest.ProcessRequest()
        {
            ...
            if (IsRequestAborted())
                logger.Debug("WebDAV request aborted... abort status code: " + this.__abortStatusCode);
            ...
            else
            {
                ...
                logger.Debug("Validating WebDAV request: " + this.__httpResponseCode);
        ...
        internal void SendResponseXML()
        {
            ...
            if (ResponseXml.Length != 0)
            {
                ...
                //For debugging
                logger.Debug("ResponseXml:" + Environment.NewLine + ResponseXml);
            }
            else
                logger.Debug("ResponseXml: [null]");
        }
        ...
        /// </summary>
        protected internal string ResponseXml
        {
            get;
            private set;
        }
        ...
        public HttpApplication HttpApplication
        {
            ...
            set
            {
                ...
                //base.HttpApplication.Response.AddHeader("Engine", "Kiss.Web.WebDAV");
        ...
        /// </summary>
        protected internal string RelativeRequestPath
        {
            get
            {
