...
namespace Kiss.Web.WebDAV
{
    ...
    public abstract class WebDAVInitializer : IPluginInitializer
    {
        ...
        {
            // 这里不设置为401是为了防止FormsAuthentication截获401
            httpApp.Response.StatusCode = 403;
            httpApp.Response.StatusDescription = "Access Denied";
            httpApp.Response.Write("403 Access Denied");
        ...
        private void context_AuthenticateRequest(object sender, EventArgs e)
        {
            ...
            DavProcessRequestArgs _processRequestArgs = new DavProcessRequestArgs(application.Context, IsWebDAVRequest);

            //Fire the event
            OnProcessRequest(_processRequestArgs);

            IsWebDAVRequest = _processRequestArgs.ProcessRequest;
        ...
        void context_EndRequest(object sender, EventArgs e)
        {
            ...
            {
                _httpApp.Response.StatusCode = 401;
